...
def login():
 ...
 Label(root2, text='Login Credentials', bd=5,font=('arial', 12, 'bold'), relief="groove", fg="white",
...
def signup():
 ...
 global username_verification
 global password_verification
 Label(root2, text='Signup Credentials', bd=5,font=('arial', 12, 'bold'), relief="groove", fg="white",
 bg="blue",width=300).pack()
 username_verification = StringVar()
 password_verification = StringVar()
 Label(root2, text="").pack()
